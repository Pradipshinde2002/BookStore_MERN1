...
// }, [theme]);
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white bg-white fixed top-0 left-0 right-0 z-50 ${sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 duration-300 transition-all ease-in-out":""}`}>
  ...
  <div className='hidden md:block'>
    <label className="input outline-none px-3 py-2 bold rounded-md flex items-center gap-2">
